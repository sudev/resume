...
%	
%	
%    \textbf{EY Innovation Center} 				\hfill Kazhakootam, Trivandrum, Kerala \\
%      \textit{Position: Associate } 			\hfill \textit{June 2014 -- present}\\
%      \textit{Technologies: R, Python }\\
%    Working as an Associate at EY Innovation, Kazhakootam, Trivandrum. My responsibility is to implement machine learning algorithms in R language.
